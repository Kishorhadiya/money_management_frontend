...
const ExpenseCategories = () => {
    ...
    const handleAddCategory = async (e) => {
        ...
        try {
            await API.post('/categories', { categoryName, level: 2 });
        ...
        <div>
            ...
            <div className="main-container">
                ...
                <div className="content">
                    <h1>
                        <i className="fas fa-tags"></i> Expense Categories
                    </h1>
                    ...
                    <div style={{ display: 'flex', gap: '30px', flexWrap: 'wrap' }}>
                        {/* Form Card */}
                        <div style={{ flex: '1', minWidth: '300px', background: '#fff', border: '1px solid #f50031', borderRadius: '4px', padding: '20px' }}>
                            <h2 style={{ margin: '-20px -20px 20px -20px', background: '#f50031', color: 'white', padding: '12px 20px', fontSize: '18px' }}>
                            ...
                            <form onSubmit={handleAddCategory}>
                                ...
                                <button
                                    type="submit"
                                    style={{ width: '100%', padding: '12px', background: '#ff6f00', color: 'white', border: 'none', borderRadius: '4px', fontSize: '16px', cursor: 'pointer' }}
                                >
                        ...
                        <div style={{ flex: '2', minWidth: '350px', background: '#fff', border: '1px solid #ccc', borderRadius: '4px' }}>
                            <div style={{ background: '#f50031', color: 'white', padding: '12px 20px', fontWeight: 'bold', fontSize: '16px' }}>
                                <i className="fas fa-list"></i> Expense Categories List
                            </div>
                    ...
                    {editModalOpen && (
                        <div className="modal-overlay">
                            <div className="modal-card">
                                <div className="modal-header">Edit Expense Category</div>
