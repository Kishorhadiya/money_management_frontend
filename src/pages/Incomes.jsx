...
const Incomes = () => {
    ...
    // Modal state for editing income
    ...
    const fetchIncomes = async (searchTerm = search) => {
        try {
            const { data } = await API.get(`/incomes?search=${encodeURIComponent(searchTerm)}`);
            setIncomes(data);
            setLoading(false);
        } catch (error) {
    ...
    const handleEditSubmit = async (e) => {
        e.preventDefault();
        try {
            await API.put(`/incomes/${editingIncome._id}`, editFormData);
    ...
    const handleDownloadCSV = () => {
        window.open(`/api/incomes/export/csv?search=${encodeURIComponent(search)}`, '_blank');
    };

    const handleDownloadPDF = () => {
        window.open(`/api/incomes/export/pdf?search=${encodeURIComponent(search)}`, '_blank');
    };
        ...
        <div>
            ...
            <div className="main-container">
                ...
                <div className="content">
                    <h1>
                        <i className="fas fa-book"></i> Income Reports
                    </h1>
                    ...
                    <div style={{ border: '1px solid #ccc' }}>
                        <div style={{ backgroundColor: '#1E88E5', padding: '12px', color: 'white', fontWeight: 'bold' }}>
                            <i className="fas fa-chart-bar"></i> History of Incomes
                        </div>
                        ...
                        <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                            ...
                            <tbody>
                                {loading ? (
                                    <tr>
                                        <td colSpan="6" style={{ textAlign: 'center', padding: '20px' }}>Loading income records...</td>
                                    </tr>
                                ) : incomes.length > 0 ? (
                                    incomes.map((row) => (
                                        <tr key={row._id}>
                    ...
                    {editModalOpen && (
                        <div className="modal-overlay">
                            <div className="modal-card">
                                <div className="modal-header">Edit Income Record</div>
